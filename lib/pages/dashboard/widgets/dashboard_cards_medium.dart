...
class DashBoardCardsMediumScreenSize extends StatefulWidget {
  const DashBoardCardsMediumScreenSize({super.key});

  @override
  State<DashBoardCardsMediumScreenSize> createState() =>
      _DashBoardCardsMediumScreenSizeState();
}

class _DashBoardCardsMediumScreenSizeState
    extends State<DashBoardCardsMediumScreenSize> {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<GlobalProvider>(builder: (context, value, child) {
