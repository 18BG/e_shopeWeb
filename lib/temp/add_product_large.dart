...
class AddProductLarge extends StatefulWidget {
  final GlobalProvider provider;
  const AddProductLarge({super.key, required this.provider});

  @override
  State<AddProductLarge> createState() => _AddProductLargeState();
}

class _AddProductLargeState extends State<AddProductLarge> {
